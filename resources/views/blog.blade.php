        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <nav class="w-full rounded-md">
                <ol class="list-reset flex">
                    <li class="text-gray-900 dark:text-gray-100">Home</li>
                </ol>
            </nav>
            ...
            <nav class="w-full rounded-md">
                <ol class="list-reset flex">
                    <li>
                        <a href="#"
                            class="text-gray transition duration-150 ease-in-out hover:text-gray-600 focus:text-gray-600 active:text-gray-700 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:text-gray-500 dark:active:text-gray-600">Home</a>
                    </li>
                    <li>
                        <span class="mx-2 text-gray-900 dark:text-gray-100">/</span>
                    </li>
                    <li class="text-gray-900 dark:text-gray-100">Library</li>
                </ol>
            </nav>
            ...
            <nav class="w-full rounded-md">
                <ol class="list-reset flex">
                    ...
                    <li>
                        <a href="#"
                            class="text-gray transition duration-150 ease-in-out hover:text-gray-600 focus:text-gray-600 active:text-gray-700 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:text-gray-500 dark:active:text-gray-600">Library</a>
                    </li>
                    <li>
                        <span class="mx-2 text-gray-900 dark:text-gray-100">/</span>
                    </li>
                    <li class="text-gray-900 dark:text-gray-100">Data</li>
                </ol>
            </nav>
